...
from commands import initialize_project, add_task, mark_task_done, add_research_note, add_purchase, add_supplier, add_task_hours, add_note_hours
...
add_task_hours("test_dev-proj", "test_task_ID-should-be-001", "1.0")
add_task_hours("test_dev-proj", "test_task_ID-should-be-001", "500")

add_note_hours("test_dev-proj", "test_note_ID-should-be-001", "1.0")
add_note_hours("test_dev-proj", "test_note_ID-should-be-001", "500")
